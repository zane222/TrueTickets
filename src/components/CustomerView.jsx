            ...
            <div className="md:col-span-2 space-y-3 sm:space-y-6">
                ...
                <div className="flex flex-col sm:flex-row gap-2 sm:gap-4">
                    <NavigationButton
                        ...
                        className="md-btn-primary elev-1 inline-flex items-center justify-center gap-2 py-3 sm:py-2 text-md sm:text-base touch-manipulation"
                    >
                    ...
                    <NavigationButton
                        ...
                        className="md-btn-surface elev-1 inline-flex items-center justify-center gap-2 py-3 sm:py-2 text-md sm:text-base touch-manipulation"
                    >
