...
import { AlertProvider } from './components/AlertSystem.jsx'
import './index.css'
...
const ensureTextVisibility = () => {
  ...
  if (color === 'rgb(0, 0, 0)' || color === 'black' || color === '' || 
    ...
    document.documentElement.style.setProperty('--md-sys-color-on-surface', '#ffffff');
    document.documentElement.style.setProperty('--md-sys-color-primary', '#1e88ff');
    document.documentElement.style.setProperty('--md-sys-color-on-primary', '#ffffff');
    document.documentElement.style.setProperty('--md-sys-color-outline', '#8f96a3');
    document.documentElement.style.setProperty('--md-sys-color-surface', '#19191b');
    document.documentElement.style.setProperty('--md-sys-color-primary-container', '#113b77');
    document.documentElement.style.setProperty('--md-sys-color-on-primary-container', '#d6e4ff');
